// ******************************************************************************************************************************
// Filename:    ProjectFile.AutoGen.cs
// Description:
// ******************************************************************************************************************************
...
// ******************************************************************************************************************************
// CSCodeGen.Parse.Project.ProjectFile (class) (public, partial)
//   Properties:
//               Encoding                      (public)
//               Root                          (public)
//               Version                       (public)
...
namespace CSCodeGen.Parse.Project
{
	//***************************************************************************************************************************
	/// <summary>
	///   Provides the methods to import and export data to/from an XML file. The schema was taken from the
	///   VHDLCodeGen.AXI.csproj file.
	/// </summary>
	//***************************************************************************************************************************
	public partial class ProjectFile
	{
		...
		//***********************************************************************************************************************
		/// <summary>Contains the root Project element in the XML file.</summary>
		//***********************************************************************************************************************
		...
		//***********************************************************************************************************************
		/// <overloads><summary>Instantiates a new ProjectFile object.</summary></overloads>
		///
		/// <summary>Instantiates a new ProjectFile object using the provided root object and XML parameters.</summary>
		///
		...
		//***********************************************************************************************************************
		public ProjectFile(Project root, string xmlEncoding, string xmlVersion)
		{
			if(root == null)
		...
		/// <overloads><summary>Instantiates a new ProjectFile object.</summary></overloads>
		///
		/// <summary>Instantiates a new ProjectFile object using the provided XML file.</summary>
		///
		...
		public void ImportFromXML(string filePath)
		{
			...
			if(string.Compare(root.Name, "Project", false) != 0)
				throw new InvalidDataException("The root node is not a 'Project' named node.");
			Root = new Project(root, 0);
		}
